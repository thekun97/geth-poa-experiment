...
type ChainConfig struct {
	...
	MuSeal *MuSealConfig `json:"MuSeal,omitempty"`
}
...
type MuSealConfig struct {
	Period uint64 `json:"period"` // Number of seconds between blocks to enforce
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint
}

func (c *MuSealConfig) String() string {
	return "MuSeal"
}
...
func (c *ChainConfig) Description() string {
	...
	case c.MuSeal != nil:
		if c.TerminalTotalDifficulty == nil {
			banner += "Consensus: MuSeal (proof-of-authority)\n"
		} else if !c.TerminalTotalDifficultyPassed {
			banner += "Consensus: MuSeal (proof-of-stake), merging from MuSeal (proof-of-authority)\n"
		} else {
			banner += "Consensus: MuSeal (proof-of-stake), merged from MuSeal (proof-of-authority)\n"
		}
	default:
